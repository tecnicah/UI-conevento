...
this.faqs =[
  {id:1	,titulo:'¿Una vez hecha la compra cuento con servicio post venta?', descripcion:	'Despreocúpate, tendrás un servicio personalizado. Una vez hecha tu compra un asesor de CONEVENTO te contactará en menos de 24 horas hábiles, el te ayudará con cualquier duda o petición. Podrás agregar servicios o cambiar tu pedido directamente con el. Tu asesor se encargará de que tus servicios lleguen en tiempo y forma coordinando directamente contigo.'},
  {id:2	,titulo:'¿Qué tan seguro es el Personal (meseros, bartender, servicio post limpieza y talento) que mandan a los eventos?', descripcion:	'Sabemos que tu seguridad es lo más importante, por lo que Conevento tiene un proceso de selección y reclutamiento muy riguroso para poder trabajar como mesero, bartender, talento o servicio de limpieza post evento. Nuestro departamento de reclutamiento no solo les hace pruebas de habilidades, sino también se les aplican pruebas psicométricas y hacen una evaluación de antecedentes no penales. Adicionalmente tus datos personales están protegidos de acuerdo a las leyes mexicanas vigentes por lo que el Personal CONEVENTO solo conocee la información indispensable para acudir a tu cita. Puedes revisar nuestro Aviso de Privacidad que se encuentra en nuestra sitio web (conevento.com).'},
  {id:3	,titulo:'¿Qué estoy pagando?', descripcion:	'Al seleccionar los servicios requeridos, se hará el apartado del pago de: la entrega de articulos en día del evento asi como la visita del personal requerido en tiempo y forma (por ej. Mesero).'},
  {id:4	,titulo:'¿Con cuanta anticipación debo contar para solicitar los servicios requeridos?', descripcion:	'4 días antes del inicio de tu evento (por ejemplo si contratas lunes tu evento debe ser al menos el viernes próximo).'},
  ...
  {id:6	,titulo:'¿En qué zonas operan?', descripcion:	'CDMX: Alvaro Obregon,Magdalena Contreras,Cuahutemoc,Miguel Hidalgo,Coyoacan,Benito Juarez,Cuajimalpa de Morelos. Próximamente estaremos abriendo más zonas.'},
  {id:7	,titulo:'¿Qué pasa si ya no necesito el servicio? ¿Si se cancela obtengo reembolso?', descripcion:	'El servicio se puede cancelar en cualquier momento 4 días antes del inicio del evento informando a tu asesor asignado o vía mail a contacto@conevento.com. En caso de cancelar el dinero será devuelto en su totalidad. Si se cancela con un periodo menor al previamente mencionado se cobrará el 50% de multa.'},
  {id:8	,titulo:'¿Qué pasa si quiero un reembolso una vez finalizado mi evento?', descripcion:	'Los reembolsos serán autorizados por CONEVENTO después de haber analizado la situación y llegar a un mutuo acuerdo con El Cliente. En caso de requerirlo es indispensable informarlo a travez de tu asesor asignado o vía mail a contacto@conevento.com. Éstos podrán ser parciales o totales , el reembolso del servicio no toma en cuenta el flete (en caso de que el servicio los incluya) , ya que éstos son ajenos al costo del servicio y se dan de manera integra al Personal. '},
  ...
  {id:10	,titulo:'¿Qué hago si tengo un problema con algun servicio contratado para mi evento?', descripcion:	'En CONEVENTO nos enfocamos a mejorar siempre tu experiencia, por eso si tienes algún problema, queja o sugerencia, puedes comunicarte a contacto@conevento.com o marcarnos al 55 6810 4838 o hacerlo directamente con tu asesor.'},
  {id:11	,titulo:'¿Cómo cambio de fecha mi evento?', descripcion:	'Cualquier cambio de horario, fecha o servicio debe hacerse con 4 días de anticipación, de lo contrario se cancelará el servicio y se te cobrará el 50% de tu evento. Para hacer un cambio de fecha: escríbenos a contacto@conevento.com, marcarnos al 55 6810 4838 o puedes hacerlo directamente con tu asesor. Es posible que al realizar cambio de fecha no se tenga disponbibilidad de algun servicio previamente contratado (debido a disponibilidad del inventario y talento), en este caso se te devolverá el 100% de tu pago.'},
  {id:12	,titulo:'¿Qué servicios ofrece Conevento?', descripcion:	'Conevento ofrece los mejores servicios  de personal y articulos para tu evento, los cuales son los siguientes: Personal (Mesero, Bartender y Servicio Post Limpiez), Talento, Renta de Mobiliario, Luces y Sonido, y Venta de Alimentos y Bebidas.'},
  ...
  {id:15	,titulo:'¿Puedo agendar un evento si no tengo tarjeta de crédito?', descripcion:	'Sí, puedes pagar un servicio aún sin tarjeta de crédito. Las opciones de pago que tenemos en nuestra página son: tarjeta de débito, Paypal y Pago en Oxxos.'},
  ...
  {id:17	,titulo:'Si contrato un servicio de renta de Artículos ¿cuándo son recogidos?', descripcion:	'Dentro de las siguientes 24hrs del termino de tu evento, si el día siguiente a tu evento es Domingo se recogen el siguiente día hábil. Tu asesor de CONEVENTO coordinará todo contigo para que se recoja en tiempo y forma.'},
