...
@Component({
  ...
  templateUrl: './wizard-login.component.html',
  styleUrls: ['./wizard-login.component.scss']
})
export class WizardLoginComponent implements OnInit {

  constructor(public spinner:SpinnerService,public _dialog: MatDialog, public dialogREF: MatDialogRef<WizardLoginComponent>, public auth:HttpService) { }
